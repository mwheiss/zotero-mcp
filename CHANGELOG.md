...
- Sequential updates compute embeddings outside the short Chroma lifecycle lock, leaving the live index readable and a second local encoder slot available to foreground searches.

...
@mcp.tool(
    ...
    description=(
        "Whole-document reading tool for one known Zotero item. Use this "
        "only when the user asks to read, comprehensively summarize, compare, "
        "or critique the paper, or when the answer depends on information "
        "spread across many sections. It can return 10K+ tokens. Do not use "
        "it for topic discovery, browsing search results, or merely checking "
        "a semantic match. For discovery call zotero_semantic_search; after a "
        ...
        "may contain little text. Scope: active library only. "
...
@mcp.tool(
    ...
    description=(
        "Switch this MCP session's active Zotero library. Subsequent API "

...
@mcp.tool(
    ...
    description=(
        ...
        "zotero_add_by_url. "
        "file_path: ABSOLUTE path on the MCP SERVER host, not a path or file "
        "upload from a remote ChatGPT/MCP client. Relative paths fail. For "
        "remote clients, prefer zotero_add_by_doi or zotero_add_by_url unless "
        "the file has already been staged on the server. Other extensions are rejected. "
